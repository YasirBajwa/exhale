    ...
    <div className="main_exercise">
      ...
      <div className="header_wrapper">
        ...
        <div className={checkIncomplete ? `btn_round ml` :`btn-grey ml`}>
          ...
          <button onClick={() => incompleteList()}>Need Completion({ headerData['Remaining Classes'] })</button>
        </div>
        <div className={checkComplete ? `btn_round ml` :`btn-grey ml`}>

          <button onClick={() => completeList()}>Completed({ headerData['Completed Classes'] })</button>
        </div>
      </div>
      {
          checkAll ?
...
export default withRouter(
  connect(mapStateToProps, mapDispatchToProps)(ClassesList)
);
