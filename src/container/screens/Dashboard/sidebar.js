    ...
    <div className="sidebar-wapper">
      ...
      <div className="sidebar-container ">
        ...
        <div className="sidebar-menues">
          <div
            className={
              dashboardColor ? `menue-list m1 ` : `menue-list m1 m-item1`
            }
            onClick={() => changeDashboard()}
          >
            <div>
              <img
                src={dashboardColor === false ? HomeImage : HomeImage2}
                alt=""
              />
            </div>
            <div
              className={
                dashboardColor === false ? `text d-text m-text` : `text d-text `
              }
            >
              Dashboard
            </div>
          ...
          <div
            className={
              changeExer
                ? `menue-list m1 m-item2 b-color`
                : `menue-list m1 m-item2`
            }
        ...
        {accountSettingColor ? (
          <div className="setting_options">
            <div
              className="s_opt_item"
              onClick={() => history.push("/dashboard/policy")}
            >
            ...
            <div
              className="s_opt_item"
              onClick={() => history.push("/dashboard/terms")}
            >
              <div className="circle"></div>
              <div className="b-circle"></div>
