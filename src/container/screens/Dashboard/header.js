        ...
        <Navbar collapseOnSelect sticky="top" expand="lg">
          <Navbar.Brand className="" as={Link} to="/" >
            <NavDropdown id="basic-nav-dropdown" 
              ...
              <NavDropdown.Item >
                  <div class="media">
                    <img class="mr-3" src={Profile} width="60" />
                    <div class="media-body">
                      <h5 class="media-title mt-0"> 
                        {profileName}
                      </h5>
                      <h5 class="media-mute mt-0">
                        {email}
                      </h5>
                    </div>
                  </div>
                  <button className="drop-btn" variant="primary"  onClick={() => handleProfileImageOpen()}>
                    <i className="fa fa-pencil mr-2"></i>Edit photo or name
                  </button>
              </NavDropdown.Item>
                      <hr></hr>
              <NavDropdown.Item>
                  <h5 className="media-mute mt-0" style={{ color: "#2E3034",fontWeight:500}}>Next sit-to-stand test</h5>
                  <h5 className="media-mute mt-0" style={{ fontSize: "16px"}}>{userProfileData.next_sts_date}</h5>
              </NavDropdown.Item>
              <NavDropdown.Item>
                  <h5 className="media-mute mt-3" style={{ color: "#2E3034",fontWeight:500}}>Program Started</h5>
                  <h5 className="media-mute mt-0" style={{ fontSize: "16px"}}>{userProfileData.program_start}</h5>
              </NavDropdown.Item>
              <NavDropdown.Item>
                  <h5 className="media-mute mt-3" style={{ color: "#2E3034",fontWeight:500}}>Program finishes</h5>
                  <h5 className="media-mute mt-0" style={{ fontSize: "16px"}}>{userProfileData.program_end}</h5>
              </NavDropdown.Item>
          </NavDropdown>
          </Navbar.Brand>
          ...
          <Navbar.Collapse id="responsive-navbar-nav" className="mr-5">
              <Nav className="mr-auto mobile-menu">
                  <NavLink className="nav-link" as={Link} to="/dashboard" >Dashboard</NavLink>
                  <NavLink className="nav-link" as={Link} to="/dashboard/list" >Exercises</NavLink>
                  <NavLink className="nav-link" as={Link} to="/dashboard/classesList" >Classes</NavLink>
                  <NavDropdown id="basic-nav-dropdown" title={`Account Settings`}>
                      ...
                      <NavDropdown.Item onClick={() =>handleShowAcc()}>
                        Delete Account
                      </NavDropdown.Item>
                  </NavDropdown>
              </Nav>
          ...
          <div className="">
            ...
            <div className="modal-input">
                  ...
                  <div className="drag-text-wrapper">
                    <div>
                      ...
                      <span className="d-txt">
                        Drag to change the position of the photo
                      </span>
                    </div>
                    <p
                      className="change-p-text"
              ...
              <div className="mt-4">
                ...
                <SignupButton className="w-100 mt-3" 
                  outline={true}
                  onClick={() => handleProfileImageClose()}
                >
                  Cancel
